...
class Oreno3dApi {
    ...
    suspend fun getVideoList(
        ...
        sort: OrenoSort
    ) : Response<OrenoPreviewList> = autoRetry {
        withContext(Dispatchers.IO){
            try {
                val request = Request.Builder()
